...
// ------------- DISCORD WEBHOOK URL -------------
const DISCORD_WEBHOOK_URL = "https://discord.com/api/webhooks/1397367876481974272/wvGLd-APlmbkN9KlnlrT5E1iddEapIAkpHo0sPg7TV1ftWyPja3sEhidhhylFOZIyu5R"; // <---- REPLACE THIS
// ----------------------------------------------
  ...
  if (isPlaying) {
    return (
      <div className="fixed inset-0 bg-black z-50">
        ...
        <iframe
          src={`https://player.videasy.net/movie/${id}?color=fbc9ff&nextEpisode=true&episodeSelector=true&autoplayNextEpisode=true&noRedirect=true&adblock=true&popup=false&mobile=true`}
